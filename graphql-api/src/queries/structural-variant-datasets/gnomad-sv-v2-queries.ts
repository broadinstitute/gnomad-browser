...
const fetchStructuralVariantsByGene = async (esClient: any, gene: any, subset: any) => {
...
const fetchStructuralVariantsByRegion = async (esClient: any, region: any, subset: any) => {
  const hits = await fetchAllSearchResults(esClient, {
    index: GNOMAD_STRUCTURAL_VARIANTS_V2_INDEX,
    type: '_doc',
    size: 10000,
