export const extendRegions = (amount: any, regions: any) =>
  regions.map(({ start, stop, xstart, xstop, ...rest }: any) => ({
    ...rest,
    start: start - amount,
    stop: stop + amount,
 ...
 */
export const mergeOverlappingRegions = (sortedRegions: any) => {
...
export const totalRegionSize = (regions: any) =>
  regions.reduce((acc: any, { start, stop }: any) => acc + stop - start, 0)
