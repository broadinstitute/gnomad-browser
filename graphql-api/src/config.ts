...
const config: Record<string, any> = {
  ...
  // CopilotKit Thread Titling
  COPILOT_TITLING_MODEL: env.COPILOT_TITLING_MODEL || 'gemini-2.0-flash',
  COPILOT_TITLE_GENERATION_THRESHOLD: JSON.parse(env.COPILOT_TITLE_GENERATION_THRESHOLD || '4'),
  COPILOT_TITLE_UPDATE_THRESHOLD: JSON.parse(env.COPILOT_TITLE_UPDATE_THRESHOLD || '10'),
