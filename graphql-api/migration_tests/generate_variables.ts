...
async function generateVariables() {
  const mappings: VariableMapping[] = [
    ...
    // --- Gene Pages ---
    {
      ...
      variables: {
        geneId: testData.genes.sln.geneId,
        referenceGenome: testData.reference_genomes.grch38,
    ...
    // --- Region Pages ---
    {
      ...
      variables: {
        ...cleanDescription(testData.regions.grch38_sln_small_region),
        referenceGenome: testData.reference_genomes.grch38,
        includeShortTandemRepeats: true,
        shortTandemRepeatDatasetId: testData.datasets.gnomad_r3
      }
    },
    {
      ...
      variables: {
        ...cleanDescription(testData.regions.grch37_sln_small_region),
        referenceGenome: testData.reference_genomes.grch37,
        includeShortTandemRepeats: false,
        shortTandemRepeatDatasetId: testData.datasets.gnomad_r3
      }
    ...
    // --- Transcript Pages ---
    {
      ...
      variables: {
        transcriptId: testData.transcripts.sln_canonical_grch38.transcriptId,
        referenceGenome: testData.reference_genomes.grch38
      }
    },
    {
