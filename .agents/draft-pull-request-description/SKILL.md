...
description: Use this whenever the user wants to open a PR, draft a pull request, or summarize their branch for merging.
...
1. **Read the Template:** Read the `.github/PULL_REQUEST_TEMPLATE.md` file.
2. **Analyze the Diff:** Run `git diff main...HEAD` to understand the holistic changes made on this branch.
3. **Draft the Content:**
...
4. **The UI Check:** Check if any changed files end in `.tsx`, `.jsx`, `.css`, or represent UI components.
5. **Output the Draft & Prompt the User:**
