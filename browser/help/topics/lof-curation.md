...
No read data was available for visualization of individuals with this variant in gnomAD (in the most up to date version as well as previous versions). In some cases we could still determine a variant was _not LoF_, due to other errors. Variants without any read data were curated as uncertain_LoF if there was no indication of other major errors.
