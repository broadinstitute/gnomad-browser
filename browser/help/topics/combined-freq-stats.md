...
Note that the statistical tests and associated discrepant frequency flag added in gnomAD v4.1 are a minimum viable product version. We will continue to iterate and improve on these analyses in future gnomAD releases.
