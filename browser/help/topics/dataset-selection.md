...
Note that gnomAD v4.1 has a single subset (non-UK Biobank), but frequencies for this subset are not displayed on the browser and are only available in our downloadable files.
