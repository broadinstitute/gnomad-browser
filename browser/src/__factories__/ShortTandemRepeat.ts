...
import { ShortTandemRepeatPropType } from '../ShortTandemRepeatPage/ShortTandemRepeatPropTypes'

const shortTandemRepeatFactory = Factory.define<ShortTandemRepeatPropType>(
  ({ params, associations }) => {
    const {
      id = 'STR1',
      ...
      associated_diseases = [
        {
          ...
          repeat_size_classifications: [
            { classification: 'Normal', max: 32, min: undefined },
            { classification: 'Intermediate', max: 38, min: 36 },
            { classification: 'Pathogenic', max: undefined, min: 39 },
          ],
          notes: 'hello world',
        },
      ],
