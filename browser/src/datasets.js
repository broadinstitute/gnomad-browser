...
const datasetLabels = {
  ...
  gnomad_r3: 'gnomAD v3.1.1',
  gnomad_r3_controls_and_biobanks: 'gnomAD v3.1.1 (controls/biobanks)',
  gnomad_r3_non_cancer: 'gnomAD v3.1.1 (non-cancer)',
  gnomad_r3_non_neuro: 'gnomAD v3.1.1 (non-neuro)',
  gnomad_r3_non_topmed: 'gnomAD v3.1.1 (non-TOPMed)',
  gnomad_r3_non_v2: 'gnomAD v3.1.1 (non-v2)',
