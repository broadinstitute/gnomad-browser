  ...
  return (
    <>
      {gene.flags.includes('chip') && (
        <p>
          <Badge level="warning">Note</Badge> This gene shows evidence of{' '}
          <ExternalLink href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8050831/">
            clonal hematopoiesis of indeterminate potential (CHIP)
          </ExternalLink>
          . The presence of somatic variants should be taken into account when interpreting the
          penetrance, pathogenicity, and frequency of potential germline variants. For more
          information, see pages 37-40 of{' '}
