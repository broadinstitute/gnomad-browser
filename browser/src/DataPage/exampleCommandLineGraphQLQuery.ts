...
query VariantsInGene {
  ...
  #
  # The gene symbol is given with quotes, but not the reference genome or
  # dataset. This is because the gene symbol is defined in the API schema as a
  # string, but the reference genome is an enumerated type that can have only
  # the value GRCh37 or GRCh38, and the dataset argument is constrained
  # similarly. See
