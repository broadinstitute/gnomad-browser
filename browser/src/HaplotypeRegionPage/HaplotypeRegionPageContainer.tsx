...
import HaplotypeRegionPage from './HaplotypeRegionPage'
...
const HaplotypeRegionPageContainer = ({ datasetId, regionId }: Props) => {
...
export default HaplotypeRegionPageContainer
