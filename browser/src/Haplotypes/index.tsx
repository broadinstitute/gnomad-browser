                  ...
                  return (
                    <>
                      <g key={`haplo-${rowIndex}`}>
                        ...
                        <line
                          x1={startX}
                          y1={12.5 + rowIndex * trackHeight}
                          x2={stopX}
                          y2={12.5 + rowIndex * trackHeight}
                          stroke='#a8a8a8'
                          strokeWidth={1}
                        />
                            ...
                            >
                              {isDottedLine ? (
                                <line
                                  ...
                                  y1={5 + rowIndex * trackHeight}
                                  x2={scalePosition(variant.position)}
                                  y2={20 + rowIndex * trackHeight}
                                  stroke={color}
                                  strokeDasharray='4 2'
