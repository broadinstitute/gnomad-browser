...
const GnomadV4Downloads = () => {
  return (
    <>
      ...
      <DownloadsSection>
        ...
        <p>
          ...
          <ExternalLink href="https://doi.org/10.1038/s41586-020-2287-8">
            <em>A structural variation reference for medical and population genetics.</em> Nature
            581, 444–451 (2020).
          </ExternalLink>
        </p>
        <FileList>
          ...
          <ListItem>
            <IndexedFileDownloadLinks
              label="SV 4.0 sites VCF"
              path="/papers/2019-sv/v4.1_sv.sites.vcf.gz"
            />
          </ListItem>
          {/* @ts-expect-error TS(2745) FIXME: This JSX tag's 'children' prop expects type 'never... Remove this comment to see the full error message */}
          <ListItem>
            <IndexedFileDownloadLinks
              label="SV 4.0 sites BED"
              path="/papers/2019-sv/gnomad_v4.1_sv.sites.bed.gz"
            />
          </ListItem>
          {/* @ts-expect-error TS(2745) FIXME: This JSX tag's 'children' prop expects type 'never... Remove this comment to see the full error message */}
          <ListItem>
            <IndexedFileDownloadLinks
              label="SV 4.0 (controls) sites VCF"
              path="/papers/2019-sv/gnomad_v4.1_sv.controls_only.sites.vcf.gz"
            />
          </ListItem>
          {/* @ts-expect-error TS(2745) FIXME: This JSX tag's 'children' prop expects type 'never... Remove this comment to see the full error message */}
          <ListItem>
            <IndexedFileDownloadLinks
              label="SV 4.0 (controls) sites BED"
              path="/papers/2019-sv/gnomad_v4.1_sv.controls_only.sites.bed.gz"
            />
          </ListItem>
          {/* @ts-expect-error TS(2745) FIXME: This JSX tag's 'children' prop expects type 'never... Remove this comment to see the full error message */}
          <ListItem>
            <IndexedFileDownloadLinks
              label="SV 4.0 (non-neuro) sites VCF"
              path="/papers/2019-sv/gnomad_v4.1_sv.nonneuro.sites.vcf.gz"
            />
          </ListItem>
          {/* @ts-expect-error TS(2745) FIXME: This JSX tag's 'children' prop expects type 'never... Remove this comment to see the full error message */}
          <ListItem>
            <IndexedFileDownloadLinks
              label="SV 4.0 (non-neuro) sites BED"
              path="/papers/2019-sv/gnomad_v4.1_sv.nonneuro.sites.bed.gz"
            />
          </ListItem>
        </FileList>
      </DownloadsSection>
      ...
      <DownloadsSection>
        <SectionTitle id="v4-linkage-disequilibrium">Linkage disequilibrium</SectionTitle>
        <LDFiles />
      </DownloadsSection>
      ...
      <DownloadsSection>
        <SectionTitle id="v4-ancestry-classification">Ancestry classification</SectionTitle>
        <p>
        ...
        <FileList>
          ...
          <ListItem>
            <GenericDownloadLinks
              ...
              path="/papers/2019-flagship-lof/v1.0/gnomad.v4.1.1.all_lofs.txt.bgz"
            />
          </ListItem>
        </FileList>
      </DownloadsSection>
        ...
        <FileList>
          ...
          <ListItem>
            <GetUrlButtons
              ...
              path="/release/2.1.1/constraint/gnomad.v4.1.1.lof_metrics.by_transcript.ht"
            />
          </ListItem>
          {/* @ts-expect-error TS(2745) FIXME: This JSX tag's 'children' prop expects type 'never... Remove this comment to see the full error message */}
          <ListItem>
            <GenericDownloadLinks
              ...
              path="/release/2.1.1/constraint/gnomad.v4.1.1.lof_metrics.by_transcript.txt.bgz"
            />
          </ListItem>
          {/* @ts-expect-error TS(2745) FIXME: This JSX tag's 'children' prop expects type 'never... Remove this comment to see the full error message */}
          <ListItem>
            <GenericDownloadLinks
              ...
              path="/release/2.1.1/constraint/gnomad.v4.1.1.lof_metrics.by_gene.txt.bgz"
            />
          </ListItem>
          {/* @ts-expect-error TS(2745) FIXME: This JSX tag's 'children' prop expects type 'never... Remove this comment to see the full error message */}
          <ListItem>
            <GenericDownloadLinks
              ...
              path="/release/2.1.1/constraint/gnomad.v4.1.1.lof_metrics.downsamplings.txt.bgz"
            />
          </ListItem>
        </FileList>
      </DownloadsSection>
      ...
      <DownloadsSection>
        ...
        <SectionTitle id="v4-multi-nucleotide-variants">
