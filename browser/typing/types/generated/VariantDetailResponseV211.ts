...
// To parse this data:
//
//   import { Convert, VariantDetailResponseV211 } from "./file";
//
//   const variantDetailResponseV211 = Convert.toVariantDetailResponseV211(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface VariantDetailResponseV211 {
    data: Data;
}
...
export class Convert {
    public static toVariantDetailResponseV211(json: string): VariantDetailResponseV211 {
        return cast(JSON.parse(json), r("VariantDetailResponseV211"));
    }

    public static variantDetailResponseV211ToJson(value: VariantDetailResponseV211): string {
        return JSON.stringify(uncast(value, r("VariantDetailResponseV211")), null, 2);
    }
}
