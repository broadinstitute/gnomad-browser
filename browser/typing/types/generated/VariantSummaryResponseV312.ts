...
// To parse this data:
//
//   import { Convert, VariantSummaryResponseV312 } from "./file";
//
//   const variantSummaryResponseV312 = Convert.toVariantSummaryResponseV312(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface VariantSummaryResponseV312 {
    data: Data;
}
...
export class Convert {
    public static toVariantSummaryResponseV312(json: string): VariantSummaryResponseV312 {
        return cast(JSON.parse(json), r("VariantSummaryResponseV312"));
    }

    public static variantSummaryResponseV312ToJson(value: VariantSummaryResponseV312): string {
        return JSON.stringify(uncast(value, r("VariantSummaryResponseV312")), null, 2);
    }
}
