...
// To parse this data:
//
//   import { Convert, GeneResponseV312 } from "./file";
//
//   const geneResponseV312 = Convert.toGeneResponseV312(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface GeneResponseV312 {
    data: Data;
}
...
export class Convert {
    public static toGeneResponseV312(json: string): GeneResponseV312 {
        return cast(JSON.parse(json), r("GeneResponseV312"));
    }

    public static geneResponseV312ToJson(value: GeneResponseV312): string {
        return JSON.stringify(uncast(value, r("GeneResponseV312")), null, 2);
    }
}
