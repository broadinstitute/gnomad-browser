...
def extract_missingness(dataset):
...
def main(argv):
    ...
    # output-root is ignored but we have it here so we can run this pipeline with deployctl
    ...
    for dataset in datasets:
        print(extract_missingness(dataset))
