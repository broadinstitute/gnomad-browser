...
pipeline.add_task(
    ...
    {"genes_path": genes_pipeline.get_task("prepare_grch37_genes")},
    {
        ...
        "curation_result_paths": [
            "gs://gnomad-public-requester-pays/truth-sets/source/lof-curation/NSD1_curation_results.csv",
            "gs://gnomad-public-requester-pays/truth-sets/source/lof-curation/gnomAD_addendum_curation_results.csv",
