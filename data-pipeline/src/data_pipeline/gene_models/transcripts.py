...
from data_pipeline.partitions import TRANSCRIPTS_NUM_PARTITIONS
...
def extract_transcripts(gene_models_path):
    ...
    ds = ds.repartition(TRANSCRIPTS_NUM_PARTITIONS, shuffle=True)
