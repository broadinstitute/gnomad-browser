  ...
  <BaseTable>
    ...
    <tbody>
      <tr>
        ...
        <td>
          Z = {renderRoundedNumber(constraint.syn_z, 2, 3, constraint.syn_z > 3.71 && '#ff2600')}
        </td>
      </tr>
      <tr>
        ...
        <td>
          Z = {renderRoundedNumber(constraint.mis_z, 2, 3, constraint.mis_z > 3.09 && '#ff9300')}
        </td>
      </tr>
      <tr>
        ...
        <td>
          pLI = {renderRoundedNumber(constraint.pLI, 2, 3, constraint.pLI > 0.9 && '#ff9300')}
        </td>
      </tr>
    </tbody>
  </BaseTable>
