  ...
  return {
    ...
    genome: {
      ...
      qualityMetrics: {
        ...
        siteQualityMetrics: [
          { metric: 'FS', value: variant.info.FS },
          { metric: 'InbreedingCoeff', value: variant.info.InbreedingCoeff },
          { metric: 'MQ', value: variant.info.MQ },
          { metric: 'MQRankSum', value: variant.info.MQRankSum },
          { metric: 'QD', value: variant.info.QD },
          { metric: 'ReadPosRankSum', value: variant.info.ReadPosRankSum },
          { metric: 'SiteQuality', value: variant.info.QUALapprox },
          { metric: 'SOR', value: variant.info.SOR },
          { metric: 'VQSLOD', value: variant.info.VQSLOD },
        ],
      },
    },
    rsid: variant.rsid,
