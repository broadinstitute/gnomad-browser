  ...
  return {
    ...
    exome: {
      ...
      qualityMetrics: {
        ...
        siteQualityMetrics: [
          { metric: 'BaseQRankSum', value: variant.BaseQRankSum },
          { metric: 'ClippingRankSum', value: variant.ClippingRankSum },
          { metric: 'DP', value: variant.DP },
          { metric: 'FS', value: variant.FS },
          { metric: 'InbreedingCoeff', value: variant.InbreedingCoeff },
          { metric: 'MQ', value: variant.MQ },
          { metric: 'MQRankSum', value: variant.MQRankSum },
          { metric: 'QD', value: variant.QD },
          { metric: 'ReadPosRankSum', value: variant.ReadPosRankSum },
          { metric: 'SiteQuality', value: variant.qual },
          { metric: 'VQSLOD', value: variant.VQSLOD },
        ],
      },
    },
